function init_fragments_TMT_diox(iTRAQ_type)
...
elseif iTRAQ_type == 10
    iTRAQ_masses = [126.128, 127.125, 127.131, 128.128, 128.134, 129.131, 129.138, 130.135, 130.141, 131.138, 230.1694, 248.1802];
    iTRAQ_names = {'TMT10 126', 'TMT10 127N', 'TMT10 127C', 'TMT10 128N', 'TMT10 128C', 'TMT10 129N', 'TMT10 129C', 'TMT10 130N', 'TMT10 130C', 'TMT10 131','TMT10 230 ?','TMT10 248 ?'};
elseif iTRAQ_type == 6
    iTRAQ_masses = [126.128, 127.125, 128.134, 129.131, 130.141, 131.138];
    iTRAQ_names = {'TMT6 126', 'TMT6 127', 'TMT6 128', 'TMT6 129', 'TMT6 130', 'TMT6 131'};
else
    iTRAQ_masses = [];
    iTRAQ_names = {};
end
...
SO2CH4 = SOCH4 + exact_mass(0,0,0,1,0,0);
